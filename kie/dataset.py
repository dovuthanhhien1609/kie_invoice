...
if __name__ == "__main__":
    ...
    parser.add_argument('-input', type=str, default="./KIE_invoice/data/result/csv_", help='input folder csv')
    parser.add_argument('-output', type=str, default="./KIE_invoice/model/GCN_data/processed", help='output path to save data')
    parser.add_argument('-cls', nargs="+", default=["company", "address", "invoice", "date","total","other"], help='array class')
