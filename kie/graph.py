...
class Grapher:
    ...
    def __init__(self, file_path):
        ...
        image_path = file_path.replace(".csv", ".jpg").replace("/csv_/", "/images/")
    ...
    def graph_formation(self, export_graph = False):
        ...
        for src_idx, src_row in df.iterrows():
            ...
            # print(src_row['xmin'] , src_row['xmax'])
        ...
        if export_graph:
            ...
            plot_path = f'./KIE_invoice/data/result/draw_images/{file_name }_graph.png'
            print(plot_path)
    ...
    def relative_distance(self, export_document_graph = False):
        ...
        if export_document_graph:
            for idx, row in df.iterrows():
                ...
                if not os.path.exists('./KIE_invoice/data/result/draw_images'):
                    os.makedirs('./KIE_invoice/data/result/draw_images')			
                
                file_name = os.path.basename(self.file_path).split(".")[0]
                plot_path = f'./KIE_invoice/data/result/draw_images/{file_name}_docu_graph.jpg'
